...
setup(
    ...
    version='0.1.0',
    url='https://github.com/joelcarranza/todoist-project-folders',
    license='BSD',
    author='Joel Carranza',
    author_email='joel@joelcarranza.com',
    description='Maintain individual folders for each Todoist project',
    ...
    entry_points={
        'console_scripts': [
            'td-project-folders = tdpf.cli:main',
        ],
    },
    classifiers=[
